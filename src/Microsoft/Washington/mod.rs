...
pub struct Fruit(pub i32);
pub const Apples: Fruit = Fruit(0i32);
pub const Oranges: Fruit = Fruit(1i32);
pub const Grapes: Fruit = Fruit(2i32);
...
impl ::core::default::Default for Fruit {
    fn default() -> Self {
        Self(0)
    }
}
unsafe impl ::windows::core::Abi for Fruit {
    type Abi = Self;
}
impl ::core::fmt::Debug for Fruit {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_tuple("Fruit").field(&self.0).finish()
    }
}
#[repr(transparent)]
